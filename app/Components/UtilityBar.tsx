...
interface UtilityBarProps{
  ...
  const UtilityBar:React.FC<UtilityBarProps> = ({data,notifications,taggableUsers,currentUser}) => {
    ...
    return ( 
        ...
        <CreatePostModal user={currentUser} image={image} taggableUsers={taggableUsers}/>
